...
finishBusiness=function(){
 ...
 ensureRivalry().pendingProfit=rivalDailyProfit();e.lastClosed=day;e.reports.unshift({day,revenue:t.revenue,net,cash:state.cash,extra:extraExpense,overhead,rows:snapshot});e.reports=e.reports.slice(0,60);
