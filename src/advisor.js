...
const ADVISOR_PORTRAIT='__ADVISOR_PORTRAIT__';
...
drawModal=function(){
 ...
 const img=document.createElement('img');img.src=ADVISOR_PORTRAIT;img.alt=T('운영 안내를 맡는 비서','運営案内を担当する秘書');img.width=112;img.height=168;
