...
공통 진입: 회사 메뉴 **사업 운영**. 발주·직원·연구·제조·운영 규정 메뉴도 대응하는 새 장부로 연결됩니다. KO/JA와 USD를 유지합니다.
...
| E5 | 공급사 자금난→공급 중단, 피로/정비 부족→처리 저하/불량, 냉장 고장→폐기 | `refWorldDay`, `refProductionAdvance`, `refOperationsDay` |
